    ...
    <div className="row">
      <div className="col-md-8 mx-auto">
        ...
        <div className="badges">
          <a className="badge-link" href="page-top"><img src="../img/google-play-badge.svg" alt=""/></a>
          <a className="badge-link" href="page-top"><img src="../img/app-store-badge.svg" alt=""/></a>
        </div>
      </div>
    </div>
  </div>
